	...
	<div class="container-fluid">
		<form method="post">
			<div align="center" class="col-md-6">
				...
				<label for="name">
					<input type="text" name="name" placeholder="Your Name" class="input-data">
				</label><br>
				<label for="phone">
					<input type="text" name="phone" placeholder="Phone Number" class="input-data">
				</label><br>
				<label for="email">
					<input type="email" name="email" placeholder="Your Email" class="input-data">
				</label><br>
				<label for="person">
					<input type="text" name="person" placeholder="How Many Presons?" class="input-data">
				</label><br>
				<label for="date">
					<input type="date" name="date" class="input-data">
				</label><br>
				<label for="enter">
